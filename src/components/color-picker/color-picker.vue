<template>
    <div :class="classes" v-clickoutside="handleClose">
        <div ref="reference" @click="toggleVisible" :class="wrapClasses">
            ...
            <i class="ivu-icon ivu-icon-arrow-down-b ivu-input-icon ivu-input-icon-normal"/>
            <div :class="inputClasses">
                <div :class="[prefixCls + '-color']">
                    ...
                    <div v-show="value || visible" :style="{backgroundColor: displayedColor}"/>
                </div>
            </div>
        </div>
                ...
                <div :class="[prefixCls + '-picker']">
                    <div :class="[prefixCls + '-picker-wrapper']">
                        <div :class="[prefixCls + '-picker-panel']">
                            <Saturation v-model="saturationColors" @change="childChange"/>
                        </div>
                        <div v-if="hue" :class="[prefixCls + '-picker-hue-slider']">
                            <Hue v-model="saturationColors" @change="childChange"/>
                        </div>
                        <div v-if="alpha" :class="[prefixCls + '-picker-alpha-slider']">
                            <Alpha v-model="saturationColors" @change="childChange"/>
                        </div>
                        <recommend-colors
                            v-if="colors.length"
                            :list="colors"
                    ...
                    <div :class="[prefixCls + '-confirm']">
                        ...
                        <Confirm @on-pick-success="handleSuccess" @on-pick-clear="handleClear"/>
                    </div>
                </div>
            </Drop>
        </transition>
