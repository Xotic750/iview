<template>
    <transition name="fade">
        <div :class="classes" @click.stop="check" :style="wraperStyles">
            <span :class="dotClasses" v-if="showDot" :style="bgColorStyle"/>
            <span :class="textClasses" :style="textColorStyle"><slot/></span>
            <Icon v-if="closable" :class="iconClass" :color="lineColor" type="ios-close-empty" @click.native.stop="close"/>
        </div>
    </transition>
</template>
<script>
