<template>
    <div :class="wrapClasses" :style="styles">
        <div :class="classes">
            <div :class="[prefixCls + '-title']" v-if="showSlotHeader" ref="title"><slot name="header"/></div>
                    ...
                    <tbody>
                        <tr>
                            <td :style="{ 'height': bodyStyle.height }">
                                <span v-html="localeNoDataText" v-if="!data || data.length === 0"/>
                                <span v-html="localeNoFilteredDataText" v-else/>
                            </td>
                        </tr>
                    </tbody>
                </table>
            ...
            <div :class="[prefixCls + '-footer']" v-if="showSlotFooter" ref="footer"><slot name="footer"/></div>
        </div>
    ...
    computed: {
        ...
        tableStyle() {
            ...
            if (this.tableWidth !== 0) {
                ...
                } else if (this.bodyHeight > this.bodyRealHeight) {
                    width = this.tableWidth;
                } else {
